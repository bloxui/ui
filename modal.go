...
func Modal(args ...x.DivArg) x.Component {
...
func ModalTrigger(args ...x.AArg) x.Component {
	return x.A(args...)
}

// ModalContent creates the modal content container with shadcn/ui styling
func ModalContent(args ...x.DivArg) x.Component {
...
func ModalHeader(args ...x.DivArg) x.Component {
...
func ModalTitle(args ...x.H2Arg) x.Component {
...
func ModalDescription(args ...x.PArg) x.Component {
...
func ModalFooter(args ...x.DivArg) x.Component {
